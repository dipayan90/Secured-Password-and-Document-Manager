...
public class docretloginlic extends Activity {
	Button back;
	ImageButton help;
	...
	Button nav2;
	 ...
	 private void addListnerOnButton3() {
		...
		@Override
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
			Intent intent= new Intent(docretloginlic.this,page2.class);
	 ...
	 private void addListnerOnButton4() {
		...
		@Override
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
			Intent intent= new Intent(docretloginlic.this,docsaveret1.class);
			startActivity(intent);
	 ...
	 private void addListnerOnButton1() {
			...
			@Override
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					Intent intent= new Intent(docretloginlic.this,help2.class);
    				startActivity(intent);
				}
			});
	 ...
	 private void addListnerOnButton2() {
		...
		//	final Context context = this;
			...
			retrieve.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					// TODO Auto-generated method stub
					Intent intent= new Intent(docretloginlic.this,displaylic.class);
    				startActivity(intent);
