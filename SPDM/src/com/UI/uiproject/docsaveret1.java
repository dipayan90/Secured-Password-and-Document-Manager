...
public class docsaveret1 extends Activity {
	ImageButton save;
	ImageButton	get;
	ImageButton back;
	ImageButton	help;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        private void addListnerOnButton() {
    		...
    		get.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View arg0) {
    				// TODO Auto-generated method stub
    				Intent intent= new Intent(docsaveret1.this,docretloginlic.class);
        ...
        private void addListnerOnButton4() {
    		...
    		nav1.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View arg0) {
    				// TODO Auto-generated method stub
    				Intent intent= new Intent(docsaveret1.this,page2.class);
    				startActivity(intent);
    			}
    		});
        }
        private void addListnerOnButton5() {
    		...
    		nav2.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View arg0) {
    				// TODO Auto-generated method stub
    				Intent intent= new Intent(docsaveret1.this,docretloginpass.class);
    				startActivity(intent);
    			}
    		});
        }
        ...
        private void addListnerOnButton2() {
    		...
    		help.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View arg0) {
    				// TODO Auto-generated method stub
    				Intent intent= new Intent(docsaveret1.this,help2.class);
    				startActivity(intent);
    			}
    		});
        }
        ...
        private void addListnerOnButton3() {
    		...
    		save.setOnClickListener(new OnClickListener() {
    			...
    			public void onClick(View arg0) {
    				// TODO Auto-generated method stub
    				Intent intent= new Intent(docsaveret1.this,password_store.class);
    				startActivity(intent);
    			}
    		});
        }
